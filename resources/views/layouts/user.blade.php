...
<head>
    ...
    <title>
        @yield('title', 'Admin Dashboard') | {{env('APP_NAME', 'upasthiti')}}
    </title>
...
<body>
        ...
        <div class="main-panel">
                ...
                <div class="main-header-logo">
                    ...
                    <div class="logo-header" data-background-color="white">
                        <a href="index.html" class="logo">
                            <img src="{{ asset('assets/frontend/img/logo/logo.png') }}" alt="navbar brand"
                ...
                <nav class="navbar navbar-header navbar-header-transparent navbar-expand-lg border-bottom">
                  ...
                  />
                        ...
                        <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                                    ...
                                    <li>
                                        <div class="message-notif-scroll scrollbar-outer">
                                            <div class="notif-center">
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="{{ asset('assets/backend/img/jm_denis.jpg') }}"
                                                            alt="Img Profile" />
                                                    </div>
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="{{ asset('assets/backend/img/chadengle.jpg') }}"
                                                            alt="Img Profile" />
                                                    </div>
                                                    <div class="notif-content">
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="{{ asset('assets/backend/img/mlane.jpg') }}"
                                                            alt="Img Profile" />
                                                    </div>
                                                    <div class="notif-content">
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="{{ asset('assets/backend/img/talha.jpg') }}"
                                                            alt="Img Profile" />
                                                    </div>
                                                    <div class="notif-content">
                            ...
                            @php
                                                        $avatar = Auth::user()->avatar ? asset('storage/' . Auth::user()->avatar) : asset('assets/frontend/img/team/ganesh.png');
                                                    @endphp
            ...
            <footer class="footer">
                <div class="container-fluid d-flex justify-content-between">
                    ...
                    <div>
                        All right reserved &copy; {{\Carbon\Carbon::now()->year}} <a target="_blank" href="https://upasthiti.org/">upasthiti</a>.
                    </div>
                </div>
            </footer>
        </div>
    ...
    <script src="{{ asset('assets/backend/js/plugin/jsvectormap/.js') }}"></script>
